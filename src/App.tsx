...
const LanguageLandingPage = React.lazy(() => import("./features/marketing/pages/LanguageLandingPage"));
...
const RentIncreasePage = React.lazy(() => import("@/features/agents/components/dashboard/RentIncreasePage"));
const KeyRegisterPage = React.lazy(() => import("@/features/agents/components/dashboard/KeyRegisterPage"));
const PMInspectionsPage = React.lazy(() => import("@/features/agents/components/dashboard/PMInspectionsPage"));
...
const SmokeAlarmsPage = React.lazy(() => import("@/features/agents/components/dashboard/SmokeAlarmsPage"));
...
const PitchTemplatesPage = React.lazy(() => import("./pages/halo/PitchTemplatesPage"));
...
const BrokerEditProfilePage = React.lazy(() => import("./pages/broker/BrokerEditProfilePage"));
            ...
            <ScrollToTop />
             ...
             <Suspense fallback={<PageLoader />}>
              ...
              <Routes>
                ...
                <Route path="/broker/portal/edit-profile" element={<BrokerEditProfilePage />} />
                ...
                <Route path="/dashboard" element={<ProtectedRoute requireAgent><AgentDashboardLayout /></ProtectedRoute>}>
                  ...
                  <Route path="pitch-templates" element={<PitchTemplatesPage />} />
