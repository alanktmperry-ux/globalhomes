...
export interface EmptyStateProps {
  /** Iconify icon name e.g. "solar:inbox-linear" */
  icon: string;
  title: string;
  body?: ReactNode;
  ctaLabel?: string;
 ...
 *
 * Default: white card with border, 64px Solar icon, py-24.
...
export const EmptyState = ({
  ...
  const iconSize = compact ? '48px' : '64px';
  ...
  return (
    <div className={`${container} ${className}`} style={containerStyle}>
      ...
      <iconify-icon icon={icon} style={{ fontSize: iconSize, color: '#E5E7EB' }} />
