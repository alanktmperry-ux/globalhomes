    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          />
          <motion.div
            className="fixed inset-x-0 top-4 bottom-[calc(env(safe-area-inset-bottom)+4.5rem)] z-50 bg-card rounded-t-3xl shadow-drawer overflow-y-auto overscroll-contain md:inset-x-auto md:left-1/2 md:top-1/2 md:bottom-auto md:-translate-x-1/2 md:-translate-y-1/2 md:w-full md:max-w-md md:rounded-2xl md:max-h-[80vh]"
