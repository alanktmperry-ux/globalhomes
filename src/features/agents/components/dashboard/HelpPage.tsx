...
const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'If the listing has not been boosted before, you will see a "Boost this listing" section at the top of the Marketing tab with two options — Featured ($49/month) and Premier ($99/month).',
      'Featured boost — $49/month: Your listing appears in the featured grid on the ListHQ homepage while active, shown specifically to buyers searching near your suburb. It also receives a Featured badge and higher placement in search results.',
      'Premier boost — $99/month: Everything in Featured, plus your listing appears at the top of all search results in your suburb, rotates through the hero image slot on the homepage, and triggers an email notification to registered buyers who have saved searches matching your property.',
      'Click "Start Featured" or "Start Premier" on your chosen tier. Your request is sent immediately to the ListHQ team.',
      'Your boost will be activated within 1 business hour. You will see the status change from "Pending activation" to "Active" once it is live.',
      ...
      'You can check the status of your boost at any time from the Marketing tab. Your boost renews automatically each month. To cancel, click "Cancel subscription" on the Marketing tab — no lock-in, no penalty.',
      'Note: Your first charge is processed on activation. The boost then renews monthly until you cancel. Cancel anytime from the Marketing tab.',
    ],
  },
  {
