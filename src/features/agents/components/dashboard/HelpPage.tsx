...
const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'You will see a "Boost this listing" section at the top with two options — Featured ($49) and Premier ($99).',
      'Featured — $49 for 30 days: Your listing appears in the homepage featured grid, shown to buyers searching near your suburb. Featured badge and higher search placement included.',
      ...
      'Click your chosen tier to see a confirmation step showing exactly what you are getting and what you will pay.',
      'Click "Confirm" to submit your request. Our team will contact you to arrange payment and activate your boost — usually within 1 business hour.',
      'Once active, your boost runs for exactly 30 days from activation. You will receive an email reminder 5 days before it ends.',
      'When your boost ends your listing returns to standard placement automatically. You will receive an email confirmation. Boost again anytime from the same tab.',
      'There is no recurring charge — each boost is a single one-off payment. Renew only when you want to.',
    ],
  },
  {
