...
const FAQ_CATEGORIES: FaqCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'How do I request a boost?', a: 'Go to My Listings, open the listing, click the Marketing tab, choose Featured or Premier, and confirm your request. Our team activates it within 1 business hour and contacts you to arrange payment.' },
      { q: 'How does payment work?', a: 'Our team contacts you to arrange payment when activating your boost. Online card payment via Stripe is coming very soon — once live, payment will be instant at checkout with no manual step.' },
      { q: 'How long does a boost last?', a: 'Exactly 30 days from the activation date. There is no automatic renewal — when your boost ends your listing simply returns to standard placement. You will receive an email reminder 5 days before expiry and a confirmation when it ends.' },
      { q: 'What happens when my boost expires?', a: 'Five days before expiry you receive an email reminder with a link to renew. When the 30 days ends your listing is automatically removed from the featured grid and returns to standard placement. You receive a confirmation email. Boost again anytime from the Marketing tab.' },
      ...
      { q: 'My boost shows Pending — what does that mean?', a: '"Pending activation" means your request has been received and is queued for activation. Our team activates boosts within 1 business hour on weekdays (8am–6pm AEST). Requests outside those hours are activated first thing next business day. Changed your mind? Email support@listhq.com.au.' },
    ],
  },
  {
