...
const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    steps: [
      'Go to My Listings in the sidebar and click on the listing you want to boost.',
      'Click the Marketing tab at the top of the listing detail page.',
      'You will see a Boost this listing section with two options — Featured ($49) and Premier ($99), both for 30 days.',
      'Featured — $49 for 30 days: Your listing appears in the homepage featured grid, shown to buyers searching near your suburb. Includes a Featured badge and higher search placement.',
      'Premier — $99 for 30 days: Everything in Featured plus top of all search results in your suburb, hero image slot on the homepage, and email alert to buyers with matching saved searches.',
      'Click Select Featured or Select Premier to open the confirmation step. This shows exactly what you are getting and the one-off price.',
      'Click Confirm to submit your request. Your listing will go live on the featured grid as soon as payment is confirmed.',
      'You will receive a bell notification the moment your boost goes live. Click it to go straight to the Marketing tab for that listing.',
      'The Marketing tab shows your live boost status at all times — including the expiry date, what is included, and a renew option.',
      'You will receive a bell notification 5 days before your boost expires, with a link to renew. After 30 days the boost ends automatically and your listing returns to standard placement.',
      'Each boost is a one-off payment. There are no automatic renewals and no subscriptions. Renew only when you want to, directly from the Marketing tab.',
    ],
  },
  {
...
const FAQ_CATEGORIES: FaqCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'How do I get my listing into the featured grid on the homepage?', a: 'Go to the listing detail page, click the Marketing tab, and request a Featured ($49) or Premier ($99) boost. Both run for 30 days as a one-off payment — no subscription. Your listing goes live as soon as payment is confirmed.' },
    ],
  },
  {
    emoji: '⚡', title: 'Featured Listing Boosts',
    items: [
      { q: 'What is a featured listing boost?', a: 'A boost puts your listing into the featured grid on the ListHQ homepage, shown to buyers searching near your suburb. It runs for 30 days from activation as a one-off payment — no subscription, no recurring charge. Two tiers: Featured ($49) and Premier ($99).' },
      { q: 'How is a boosted listing different from a standard listing?', a: 'A standard listing appears in search results based on relevance and recency. A Featured boost places your listing in the homepage featured grid with a Featured badge, higher search placement, and targeted visibility to buyers searching near your suburb. Premier adds top-of-search in your suburb, the hero image slot on the homepage, and an email to buyers with matching saved searches.' },
      { q: 'Who sees my featured listing?', a: 'Buyers who visit the ListHQ homepage near your suburb — detected via their GPS location, IP address, or suburb search query. If a buyer searches "3 bed house in Doncaster" they see featured listings from Doncaster. The targeting is automatic.' },
      { q: 'How much does a boost cost?', a: 'Featured is $49 for 30 days. Premier is $99 for 30 days. Both are one-off payments — no subscription, no recurring charge. Renew only when you want to.' },
      { q: 'How do I request a boost?', a: 'Go to My Listings, open the listing, click the Marketing tab, choose Featured or Premier, and confirm. Your listing goes live on the featured grid as soon as payment is confirmed. You get a bell notification the moment it is live.' },
      { q: 'How does payment work?', a: 'Stripe card payment is coming very soon — once live, your boost will go live instantly on payment with no manual step. In the meantime, payment is arranged on confirmation and your listing goes live promptly.' },
      { q: 'How long does a boost last?', a: 'Exactly 30 days from the activation date. There is no automatic renewal — when your boost ends your listing simply returns to standard placement. You will receive a bell notification 5 days before expiry and a confirmation when it ends.' },
      { q: 'What happens when my boost expires?', a: 'Five days before expiry you receive a bell notification with a link to renew. When the 30 days ends your listing is automatically removed from the featured grid and returns to standard placement. Boost again anytime from the Marketing tab.' },
      { q: 'Can I renew my boost?', a: 'Yes — anytime. Go back to the Marketing tab on your listing after your current boost ends and request a new one. Each boost is an independent one-off payment.' },
      { q: 'What is the difference between Featured and Premier?', a: 'Featured ($49 for 30 days): Homepage featured grid, Featured badge, higher search placement, targeted to buyers near your suburb. Premier ($99 for 30 days): Everything in Featured, plus top position in all search results in your suburb, rotation in the homepage hero image slot, and an email to registered buyers with saved searches matching your property.' },
      ...
      { q: 'Can I have more than one listing boosted at the same time?', a: 'Yes. Each listing is boosted independently. There is no limit on how many listings you can boost simultaneously.' },
      { q: 'My boost shows Pending — what does that mean?', a: 'Pending means your request is being processed and payment is being confirmed. Your listing will go live on the featured grid as soon as this is done. You will get a bell notification the moment it is active. Check the Marketing tab anytime to see the current status.' },
    ],
  },
  {
