...
const FAQ_CATEGORIES: FaqCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'When am I charged for a boost?', a: 'Your first charge is processed on activation, not on request. The boost then renews monthly until you cancel. Cancel anytime from the Marketing tab.' },
      { q: 'How long does a boost last?', a: 'Your boost renews automatically each month until you cancel. You can cancel anytime from the Marketing tab — click "Cancel subscription". No lock-in, no penalty.' },
      ...
      { q: 'What is the difference between Featured and Premier?', a: 'Featured ($49/month): Homepage featured grid while active, Featured badge, higher search placement, targeted to buyers near your suburb. Premier ($99/month): Everything in Featured, plus top position in all search results in your suburb, rotation in the homepage hero image slot, and an email notification sent to registered buyers with saved searches matching your property type, suburb, and price range.' },
      ...
      { q: 'Can I cancel a boost?', a: 'Yes — cancel anytime from the Marketing tab on your listing. Click "Cancel subscription" and your boost stops at the end of the current billing period. No lock-in, no penalty.' },
