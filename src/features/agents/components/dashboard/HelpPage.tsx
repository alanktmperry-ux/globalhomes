...
const FAQ_CATEGORIES: FaqCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'How do I get my listing into the featured grid on the homepage?', a: 'Go to the listing detail page, click the Marketing tab, and request a Featured ($49) or Premier ($99) boost. Both run for 30 days as a one-off payment — no subscription. Activated within 1 business hour.' },
    ],
  },
  {
