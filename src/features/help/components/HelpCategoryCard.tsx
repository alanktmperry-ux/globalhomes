...
import { Building2, Home, Key, BarChart3, Hammer, CreditCard, HelpCircle, Settings, ClipboardCheck, ClipboardList, Briefcase, Zap, type LucideIcon } from 'lucide-react';
import { Card } from '@/components/ui/card';

const iconMap: Record<string, LucideIcon> = {
  Building2, Home, Key, BarChart3, Hammer, CreditCard, HelpCircle, Settings, ClipboardCheck, ClipboardList, Briefcase, Zap,
};
