        ...
        >
          <div className="flex justify-between items-center mb-6">
            ...
            <span className="flex items-center gap-2 text-[12px] font-semibold text-white">
              ...
              {t("marketing.voice.demo.recording")}
            </span>
          </div>
