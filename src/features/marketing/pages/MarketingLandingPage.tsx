...
const aiBuilds = [
  ...
  },
  {
    ...
    desc: 'Voice-powered search matches buyers to properties in seconds. any language, instant results, qualified leads.',
      ...
      <section id="pricing" className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">60-day free trial for founding agents. No lock-in contracts. Cancel anytime.</p>
          </div>
