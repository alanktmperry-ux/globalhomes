      ...
      <div className="p-4 sm:p-6 max-w-4xl space-y-6">
        ...
        {!loading && sessions.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="font-semibold text-foreground">No inspections scheduled</p>
            <p className="text-sm text-muted-foreground mt-1">Create your first open home to start collecting registrations</p>
            {agentId && (
