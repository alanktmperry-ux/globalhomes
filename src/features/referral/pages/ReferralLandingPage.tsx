...
export default function ReferralLandingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If email confirmation is required, we cannot insert yet (no session/JWT).
      // Show success with verification message; the dashboard will handle profile creation on first login.
      if (!authData.session) {
        setSuccess({ code: '', needsVerification: true });
        setSubmitting(false);
        return;
      }
