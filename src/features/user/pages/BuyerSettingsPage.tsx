...
import { User, Bell, MapPin, DollarSign, Camera, Loader2, ArrowLeft, Home, Shield, ShieldCheck } from 'lucide-react';
import { PreApprovalUploadPanel } from '@/components/preapproval/PreApprovalUploadPanel';
  ...
  return (
    <div className="min-h-screen bg-background pb-28">
      ...
      <main className="max-w-lg mx-auto px-4 py-4 space-y-4">
        ...
        <div className="bg-card border border-border rounded-xl p-5 space-y-4">
          <h3 className="font-display text-sm font-bold flex items-center gap-1.5">
            <ShieldCheck size={14} /> Finance Verification
          </h3>
          <PreApprovalUploadPanel />
        </div>
