...
import { SlidersHorizontal, X, ChevronDown, ChevronUp, RotateCcw, PawPrint, Home, GraduationCap, Sofa, BadgeCheck } from 'lucide-react';
...
// Australian school catchment zones — common metropolitan zones
const SCHOOL_ZONES = [
