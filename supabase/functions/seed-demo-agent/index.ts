      ...
      await supabaseAdmin.from("properties").insert([
        {
          ...
          title: "South Yarra 4 Bed $2.8M",
          address: "42 Domain Rd, South Yarra VIC 3141",
          suburb: "South Yarra",
          state: "VIC",
          country: "Australia",
          price: 2800000,
          ...
          status: "off-market",
          listing_type: "sale",
          description: "Stunning four-bedroom residence in the heart of South Yarra with premium finishes throughout.",
          lat: -37.8380,
          lng: 145.0180,
          views: 234,
          contact_clicks: 18,
        ...
        {
          agent_id: agentRecord.id,
          title: "Toorak Penthouse $3.5M",
          address: "88 Orrong Rd, Toorak VIC 3142",
          suburb: "Toorak",
          state: "VIC",
          country: "Australia",
          price: 3500000,
          ...
          status: "off-market",
          listing_type: "sale",
          description: "Luxurious penthouse with panoramic city views in prestigious Toorak.",
          lat: -37.8407,
          lng: 145.0109,
          views: 412,
          contact_clicks: 31,
